...
T30 = T26*T29;
T40 = exp(y(4))^(1-params(3));
T43 = exp(y(6))^(params(3)-1);
T44 = params(3)*exp(y(1))*T40*T43;
...
residual(4)= lhs-rhs;
lhs =y(1);
rhs =params(6)+y(1)*params(7)+params(8)*x(1);
residual(5)= lhs-rhs;
lhs =exp(y(2));
rhs =T29*exp(y(1))*T40;
residual(6)= lhs-rhs;
...
T94 = exp(y(4))*getPowerDeriv(exp(y(4)),1-params(3),1);
T115 = exp(y(6))*getPowerDeriv(exp(y(6)),params(3),1);
T126 = params(3)*exp(y(1))*T40*exp(y(6))*getPowerDeriv(exp(y(6)),params(3)-1,1);
  ...
  g1(2,6)=(-(T16*T26*T115));
  g1(3,1)=(-(T10*T44));
  g1(3,4)=(-(T10*T43*params(3)*exp(y(1))*T94));
  g1(3,5)=(-(T44*(-exp(y(5)))/(exp(y(5))*exp(y(5)))));
  g1(3,6)=(-(params(2)*(-exp(y(6)))))/((1-exp(y(6)))*(1-exp(y(6))))-T10*T126;
  g1(4,1)=T49;
  g1(4,4)=exp(y(4))*(1-params(4))+T29*exp(y(1))*getPowerDeriv(y(4),1-params(3),1)-params(5)*exp(y(4));
  g1(4,5)=(-exp(y(5)));
  g1(4,6)=T48*T115;
  g1(5,1)=1-params(7);
  g1(6,1)=(-(T29*exp(y(1))*T40));
  g1(6,2)=exp(y(2));
  g1(6,4)=(-(T29*exp(y(1))*T94));
  g1(6,6)=(-(exp(y(1))*T40*T115));
  g1(7,2)=exp(y(2));
  g1(7,3)=(-exp(y(3)));
  g1(7,5)=(-exp(y(5)));
  g1(8,1)=(-T44);
  g1(8,4)=(-(T43*params(3)*exp(y(1))*T94));
  g1(8,6)=(-T126);
  g1(8,8)=exp(y(8));
  g1(9,1)=(-T30);
  g1(9,4)=(-T90);
